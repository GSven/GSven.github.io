$(document).ready(function(){
	...
	//***********************
     //**评论的代码也删掉哦***
     window.disqus_shortname = 'gsven'; // required: replace example with your forum shortname
    ...
    (function lastModifedTime() {
      ...
      $.ajax({
        url: 'https://api.github.com/repos/GSven/GSven.github.io/commits?path=/' + $lm.data('source'),
        method: 'GET',
